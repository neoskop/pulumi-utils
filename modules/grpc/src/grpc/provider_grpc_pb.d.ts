...
interface IResourceProviderService_IGetSchema extends grpc.MethodDefinition<provider_pb.GetSchemaRequest, provider_pb.GetSchemaResponse> {
    path: string; // "/pulumirpc.ResourceProvider/GetSchema"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<provider_pb.GetSchemaRequest>;
    requestDeserialize: grpc.deserialize<provider_pb.GetSchemaRequest>;
    responseSerialize: grpc.serialize<provider_pb.GetSchemaResponse>;
    responseDeserialize: grpc.deserialize<provider_pb.GetSchemaResponse>;
}
...
export interface IResourceProviderServer {
    getSchema: grpc.handleUnaryCall<provider_pb.GetSchemaRequest, provider_pb.GetSchemaResponse>;
...
export interface IResourceProviderClient {
    getSchema(
        request: provider_pb.GetSchemaRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.GetSchemaResponse) => void
    ...
    checkConfig(
        request: provider_pb.CheckRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.CheckResponse) => void
    ): grpc.ClientUnaryCall;
    checkConfig(
        request: provider_pb.CheckRequest,
        metadata: grpc.Metadata,
    ...
    diffConfig(
        request: provider_pb.DiffRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.DiffResponse) => void
    ): grpc.ClientUnaryCall;
    diffConfig(
        request: provider_pb.DiffRequest,
        metadata: grpc.Metadata,
    ...
    configure(
        request: provider_pb.ConfigureRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.ConfigureResponse) => void
    ): grpc.ClientUnaryCall;
    configure(
        request: provider_pb.ConfigureRequest,
        metadata: grpc.Metadata,
    ...
    invoke(
        request: provider_pb.InvokeRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.InvokeResponse) => void
    ): grpc.ClientUnaryCall;
    invoke(
        request: provider_pb.InvokeRequest,
        metadata: grpc.Metadata,
    ...
    streamInvoke(
        request: provider_pb.InvokeRequest,
        options?: Partial<grpc.CallOptions>
    ): grpc.ClientReadableStream<provider_pb.InvokeResponse>;
    streamInvoke(
        request: provider_pb.InvokeRequest,
        metadata?: grpc.Metadata,
        options?: Partial<grpc.CallOptions>
    ...
    create(
        request: provider_pb.CreateRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.CreateResponse) => void
    ): grpc.ClientUnaryCall;
    create(
        request: provider_pb.CreateRequest,
        metadata: grpc.Metadata,
    ...
    read(
        request: provider_pb.ReadRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.ReadResponse) => void
    ): grpc.ClientUnaryCall;
    read(
        request: provider_pb.ReadRequest,
        metadata: grpc.Metadata,
    ...
    update(
        request: provider_pb.UpdateRequest,
        callback: (error: grpc.ServiceError | null, response: provider_pb.UpdateResponse) => void
    ): grpc.ClientUnaryCall;
    update(
        request: provider_pb.UpdateRequest,
        metadata: grpc.Metadata,
    ...
    delete(
        request: provider_pb.DeleteRequest,
    ...
    getPluginInfo(
        request: google_protobuf_empty_pb.Empty,
        callback: (error: grpc.ServiceError | null, response: plugin_pb.PluginInfo) => void
    ): grpc.ClientUnaryCall;
    getPluginInfo(
        request: google_protobuf_empty_pb.Empty,
        metadata: grpc.Metadata,
