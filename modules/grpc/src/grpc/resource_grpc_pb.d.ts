...
interface IResourceMonitorService_ISupportsFeature
    extends grpc.MethodDefinition<resource_pb.SupportsFeatureRequest, resource_pb.SupportsFeatureResponse> {
...
interface IResourceMonitorService_IReadResource
    extends grpc.MethodDefinition<resource_pb.ReadResourceRequest, resource_pb.ReadResourceResponse> {
...
interface IResourceMonitorService_IRegisterResource
    extends grpc.MethodDefinition<resource_pb.RegisterResourceRequest, resource_pb.RegisterResourceResponse> {
...
interface IResourceMonitorService_IRegisterResourceOutputs
    extends grpc.MethodDefinition<resource_pb.RegisterResourceOutputsRequest, google_protobuf_empty_pb.Empty> {
...
export interface IResourceMonitorClient {
    supportsFeature(
        request: resource_pb.SupportsFeatureRequest,
        callback: (error: grpc.ServiceError | null, response: resource_pb.SupportsFeatureResponse) => void
    ...
    readResource(
        request: resource_pb.ReadResourceRequest,
        callback: (error: grpc.ServiceError | null, response: resource_pb.ReadResourceResponse) => void
    ): grpc.ClientUnaryCall;
    readResource(
        request: resource_pb.ReadResourceRequest,
        metadata: grpc.Metadata,
    ...
    registerResource(
        request: resource_pb.RegisterResourceRequest,
        callback: (error: grpc.ServiceError | null, response: resource_pb.RegisterResourceResponse) => void
    ): grpc.ClientUnaryCall;
    registerResource(
        request: resource_pb.RegisterResourceRequest,
        metadata: grpc.Metadata,
    ...
    registerResourceOutputs(
        request: resource_pb.RegisterResourceOutputsRequest,
...
export class ResourceMonitorClient extends grpc.Client implements IResourceMonitorClient {
    ...
    public registerResourceOutputs(
        request: resource_pb.RegisterResourceOutputsRequest,
        callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void
    ): grpc.ClientUnaryCall;
    public registerResourceOutputs(
