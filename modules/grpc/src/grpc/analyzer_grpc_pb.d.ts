...
interface IAnalyzerService_IConfigure extends grpc.MethodDefinition<analyzer_pb.ConfigureAnalyzerRequest, google_protobuf_empty_pb.Empty> {
    path: string; // "/pulumirpc.Analyzer/Configure"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<analyzer_pb.ConfigureAnalyzerRequest>;
    requestDeserialize: grpc.deserialize<analyzer_pb.ConfigureAnalyzerRequest>;
...
export interface IAnalyzerServer {
    ...
    configure: grpc.handleUnaryCall<analyzer_pb.ConfigureAnalyzerRequest, google_protobuf_empty_pb.Empty>;
}

export interface IAnalyzerClient {
    analyze(
        request: analyzer_pb.AnalyzeRequest,
        callback: (error: grpc.ServiceError | null, response: analyzer_pb.AnalyzeResponse) => void
    ...
    analyzeStack(
        request: analyzer_pb.AnalyzeStackRequest,
        callback: (error: grpc.ServiceError | null, response: analyzer_pb.AnalyzeResponse) => void
    ): grpc.ClientUnaryCall;
    analyzeStack(
        request: analyzer_pb.AnalyzeStackRequest,
    ...
    getAnalyzerInfo(
        ...
        callback: (error: grpc.ServiceError | null, response: analyzer_pb.AnalyzerInfo) => void
    ): grpc.ClientUnaryCall;
    getAnalyzerInfo(
        request: google_protobuf_empty_pb.Empty,
        metadata: grpc.Metadata,
    ...
    configure(
        request: analyzer_pb.ConfigureAnalyzerRequest,
