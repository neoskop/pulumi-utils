...
interface IEngineService_IGetRootResource
    extends grpc.MethodDefinition<engine_pb.GetRootResourceRequest, engine_pb.GetRootResourceResponse> {
...
interface IEngineService_ISetRootResource
    extends grpc.MethodDefinition<engine_pb.SetRootResourceRequest, engine_pb.SetRootResourceResponse> {
...
export interface IEngineClient {
    ...
    getRootResource(
        request: engine_pb.GetRootResourceRequest,
        callback: (error: grpc.ServiceError | null, response: engine_pb.GetRootResourceResponse) => void
    ): grpc.ClientUnaryCall;
    getRootResource(
        request: engine_pb.GetRootResourceRequest,
        metadata: grpc.Metadata,
    ...
    setRootResource(
        request: engine_pb.SetRootResourceRequest,
        callback: (error: grpc.ServiceError | null, response: engine_pb.SetRootResourceResponse) => void
    ): grpc.ClientUnaryCall;
    setRootResource(
        request: engine_pb.SetRootResourceRequest,
        metadata: grpc.Metadata,
