...
interface ILanguageRuntimeService_IGetRequiredPlugins
    extends grpc.MethodDefinition<language_pb.GetRequiredPluginsRequest, language_pb.GetRequiredPluginsResponse> {
...
export interface ILanguageRuntimeClient {
    getRequiredPlugins(
        request: language_pb.GetRequiredPluginsRequest,
        callback: (error: grpc.ServiceError | null, response: language_pb.GetRequiredPluginsResponse) => void
    ...
    run(
        request: language_pb.RunRequest,
        callback: (error: grpc.ServiceError | null, response: language_pb.RunResponse) => void
    ): grpc.ClientUnaryCall;
    run(
        request: language_pb.RunRequest,
        metadata: grpc.Metadata,
